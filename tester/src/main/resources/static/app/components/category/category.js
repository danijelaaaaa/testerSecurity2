(function() {
	"use strict";
	angular.module('tester.category').controller('CategoryController',
			CategoryController);

	CategoryController.$inject = [ 'CategoryService', '$scope', '$state',
			'$stateParams', '$location', 'auth' ];
	function CategoryController(CategoryService, $scope, $state, $stateParams,
			$location, auth) {
